# adapted from https://gist.github.com/zzzxxxttt/4ea0e1bac0293fee518035ae52394746
# converts BDD labels to COCO format with labels aligned to KITTI categories
...
def bdd2coco_detection(labeled_images, save_dir):
    ...
    for i in tqdm(labeled_images):
        ...
        for l in i['labels']:
            annotation = dict()
            if l['category'] in category_map.keys():
                tmp = 1
                empty_image = False
                ...
                annotation['category_id'] = id_dict[category_map[l['category']]]
                annotation['ignore'] = 0
                annotation['id'] = l['id']
